...
print("Execution time of test without OpenCL: ", cputime, "s")
...
for platform in cl.get_platforms():
    for device in platform.get_devices():
        ...
        exec_evt.wait()
        gputime = 1e-9*(exec_evt.profile.end - exec_evt.profile.start)

        print("Execution time of test: %g s" % gputime)

        print("Times Faster:", cputime / gputime, "x")
